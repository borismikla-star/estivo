...
export default function Layout({ children, currentPageName }) {
  ...
  const translations = {
      en: {
          ...
          portfolio: "Portfolio",
          compare: "Compare",
          land_feasibility: "Land Feasibility Analysis",
          settings: "Settings",
          logout: "Logout",
      ...
      sk: {
          ...
          portfolio: "Portfólio",
          compare: "Porovnať",
          land_feasibility: "Analýza uskutočniteľnosti na pozemku",
          settings: "Nastavenia",
          logout: "Odhlásiť sa",
      ...
      pl: {
          ...
          portfolio: "Portfolio",
          compare: "Porównaj",
          land_feasibility: "Analiza wykonalności gruntu",
          settings: "Ustawienia",
          logout: "Wyloguj się",
      ...
      de: {
          ...
          portfolio: "Portfolio",
          compare: "Vergleichen",
          land_feasibility: "Grundstücks-Machbarkeitsanalyse",
