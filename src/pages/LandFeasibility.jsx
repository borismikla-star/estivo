...
const translations = {
  ...
  pl: {
    ...
    title: "Analiza wykonalności gruntu",
    subtitle: "Generator koncepcji — analiza potencjału działki przed zakupem",
    new_concept: "Nowa koncepcja",
    my_concepts: "Moje koncepcje",
    editor: "Edytor",
    concept_name: "Nazwa koncepcji",
    save: "Zapisz",
    saving: "Zapisywanie…",
    back_to_list: "Wróć do listy",
    transfer_title: "Przenieś do kalkulatora deweloperskiego",
    transfer_confirm: "Zostanie utworzony nowy projekt w kalkulatorze deweloperskim z danymi z tej koncepcji. Kontynuować?",
    transfer_ok: "Przenieś",
    cancel: "Anuluj",
    transferred_ok: "Przeniesiono! Przekierowuję do kalkulatora…",
    unsaved: "Niezapisane",
    new_concept_placeholder: "np. Działka Warszawa – Mokotów",
  },
  hu: {
    export_pdf: "PDF exportálása",
    title: "Telek megvalósíthatósági elemzés",
    subtitle: "Koncepciógenerátor — vételár előtti telekelemzés",
    new_concept: "Új koncepció",
    my_concepts: "Koncepcióim",
    editor: "Szerkesztő",
    concept_name: "Koncepció neve",
    save: "Mentés",
    saving: "Mentés…",
    back_to_list: "Vissza a listához",
    transfer_title: "Átvinni a fejlesztői kalkulátorba",
    transfer_confirm: "Új projekt jön létre a fejlesztői kalkulátorban ennek a koncepciónak az adataival. Folytatja?",
    transfer_ok: "Átvitel",
    cancel: "Mégse",
    transferred_ok: "Átvive! Átirányítás a kalkulátorhoz…",
    unsaved: "Nem mentett",
    new_concept_placeholder: "pl. Telek Budapest – XI. kerület",
  },
  de: {
    export_pdf: "PDF exportieren",
    title: "Grundstücks-Machbarkeitsanalyse",
    subtitle: "Konzeptgenerator — Grundstücksanalyse vor dem Kauf",
    new_concept: "Neues Konzept",
    my_concepts: "Meine Konzepte",
    editor: "Editor",
    concept_name: "Konzeptname",
    save: "Speichern",
    saving: "Speichere…",
    back_to_list: "Zurück zur Liste",
    transfer_title: "In den Entwicklungsrechner übertragen",
    transfer_confirm: "Es wird ein neues Projekt im Entwicklungsrechner mit den Daten dieses Konzepts erstellt. Fortfahren?",
    transfer_ok: "Übertragen",
    cancel: "Abbrechen",
    transferred_ok: "Übertragen! Weiterleitung zum Rechner…",
    unsaved: "Ungespeichert",
    new_concept_placeholder: "z.B. Grundstück Wien – Döbling",
  },
};
          ...
          <div className="flex items-center gap-2">
            {view === 'editor' ? (
              <>
                ...
                <Button size="sm" variant="outline" onClick={() => exportConceptToPDF(conceptName, results, language, inputs)} className="gap-1.5">
