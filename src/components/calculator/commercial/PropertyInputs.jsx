...
export default function PropertyInputs({ data, onChange, language = 'en' }) {
    ...
    const translations = {
        en: {
            ...
            acquisition_auto_desc: "Auto-calculated as 4% of purchase price (taxes, notary, legal fees)",
        ...
        sk: {
            ...
            acquisition_auto_desc: "Automatický výpočet: 4% z kúpnej ceny (dane, notár, právne poplatky)",
