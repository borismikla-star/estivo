...
const translations = {
  ...
  pl: {
    no_concepts: "Brak zapisanych koncepcji.",
    transferred: "Przeniesione",
    draft: "Szkic",
    completed: "Ukończone",
    open: "Otwórz",
    delete: "Usuń",
    transfer: "Przenieś do kalkulatora",
    apts: "mieszkań",
    npp: "PUB",
    parcels: "działek",
    subdivision_label: "Parcelacja",
  },
  hu: {
    no_concepts: "Még nincsenek mentett koncepciók.",
    transferred: "Átvive",
    draft: "Vázlat",
    completed: "Befejezett",
    open: "Megnyitás",
    delete: "Törlés",
    transfer: "Átvitel a kalkulátorba",
    apts: "lakás",
    npp: "NFA",
    parcels: "telek",
    subdivision_label: "Telekfelosztás",
  },
  de: {
    no_concepts: "Noch keine gespeicherten Konzepte.",
    transferred: "Übertragen",
    draft: "Entwurf",
    completed: "Abgeschlossen",
    open: "Öffnen",
    delete: "Löschen",
    transfer: "In Rechner übertragen",
    apts: "Whg.",
    npp: "NFA",
    parcels: "Parzellen",
    subdivision_label: "Parzellierung",
  },
};
