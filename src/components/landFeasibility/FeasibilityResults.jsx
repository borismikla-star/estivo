...
const translations = {
  ...
  sk: {
    ...
    tooltips: {
      land_area: "Celková výmera posudzovaného pozemku (vstup).",
      built_area: "Maximálna zastavaná plocha = výmera pozemku × IZ (koeficient zastavania). Odvodzuje sa z regulatívnych vstupov.",
      hpp_above: "Hrubá podlahová plocha nadzemných podlaží = výmera pozemku × KPP (koeficient podlažných plôch). Ak nie je KPP zadané, vypočíta sa ako zastavaná plocha × počet podlaží.",
      effective_hpp_above: "HPP nadzemné znížené o Urban Risk Buffer — zohľadňuje regulatívne obmedzenia, stavebné povolenie a projektové riziká.",
      hpp_below: "Hrubá podlahová plocha podzemných podlaží. Vypočíta sa ako: kryté parkovacie miesta × 25 m² + kobky (3 m²/byt) + technické priestory (5 % z parkovacej plochy) + obslužné komunikácie (20 % z parkovacej plochy).",
      npp_above: "Čistá podlahová plocha nadzemných podlaží = HPP nadzemné × koeficient efektívnosti (konzervatívny 75 %, realistický 80 %, optimistický 85 %).",
      npp_below: "Čistá podlahová plocha podzemných podlaží = HPP podzemné × 85 %.",
      apartments_area: "Čistá plocha bytov = ČPP nadzemné × (1 − % nebytových priestorov − 10 % spoločné priestory).",
      non_residential_area: "Čistá plocha nebytových priestorov = ČPP nadzemné × % nebytových priestorov.",
      balconies_area: "Odhadovaná plocha balkónov = plocha bytov × 10 %. Nezapočítava sa do bilancie pozemku.",
      front_gardens_area: "Informatívny odhad predzáhradiek = plocha bytov × 5 %. Súčasť zelene na teréne.",
      parking_covered: "Počet krytých / podzemných parkovacích miest = počet bytov × koeficient kryté parkovanie.",
      parking_outdoor: "Počet vonkajších parkovacích miest = počet bytov × koeficient vonkajšie parkovanie. Zarátava sa do bilancie pozemku.",
      paved_area: "Celková spevnená plocha na teréne = základné % spevnených plôch + plocha vonkajšieho parkovania. Zarátava sa do bilancie pozemku.",
      green_terrain: "Zbytková zeleň na teréne = výmera pozemku − zastavaná plocha − spevnené plochy. Musí spĺňať regulatívne minimum zelene.",
      green_on_structure: "Zelená strecha / zazelenená terasa na konštrukcii budovy. Nezapočítava sa do bilancie pozemku.",
      cellars_area: "Odhadovaná plocha kobiek/pivníc = počet bytov × 3 m². Súčasť HPP podzemného podlažia.",
      apartment_count: "Odhadovaný počet bytov = plocha bytov ÷ priemerná veľkosť bytu (vstup).",
    },
    warnings: {
