...
const LABELS = {
  en: {
    ...
    inputs_land: "Land & Regulatory",
    inputs_advanced: "Advanced Assumptions",
    inputs_subdivision: "Subdivision Parameters",
    inp_land_area: "Total Land Area",
    inp_project_type: "Project Type",
    inp_project_type_building: "Building Development",
    inp_project_type_subdivision: "Subdivision",
    inp_iz: "Plot Coverage Ratio (IZ)",
    inp_kpp: "Floor Area Ratio (KPP)",
    inp_floors: "Above-Ground Floors",
    inp_non_res_pct: "Non-Residential %",
    inp_min_green_pct: "Min. Green %",
    inp_avg_apt: "Avg. Apartment Size",
    inp_mode: "Calculation Mode",
    inp_mode_conservative: "Conservative (72%)",
    inp_mode_realistic: "Realistic (75%)",
    inp_mode_efficient: "Efficient (80%)",
    inp_green_on_structure: "Green on Structure",
    inp_parking_ratio: "Covered Parking / Apt",
    inp_outdoor_ratio: "Outdoor Parking / Apt",
    inp_paved_pct: "Paved Area % of site",
    inp_urban_risk_buffer: "Urban Risk Buffer %",
    inp_public_roads_pct: "Public Roads %",
    inp_green_pct: "Min. Green on Site %",
    inp_paved_pct_house: "Paved % per Parcel",
    inp_min_parcel_size: "Min. Parcel Size",
    inp_max_plot_coverage: "Max Plot Coverage %",
    inp_floors_per_house: "Floors per House",
    inp_kpp_house: "KPP per House",
    inp_typology: "House Typology",
    inp_typology_detached: "Detached",
    inp_typology_semi: "Semi-detached",
    inp_typology_row: "Row House",
    inp_risk_buffer_pct: "Design Efficiency Buffer %",
    inp_parking_per_house: "Parking per House",
    inp_yes: "Yes",
    inp_no: "No",
    inp_not_set: "—",
    m2: "m²",
  ...
  sk: {
    ...
    inputs_title: "Vstupné parametre",
    inputs_land: "Pozemok & regulatívy",
    inputs_advanced: "Pokročilé predpoklady",
    inputs_subdivision: "Parametre parcelácie",
    inp_land_area: "Výmera pozemku",
    inp_project_type: "Typ projektu",
    inp_project_type_building: "Bytová výstavba",
    inp_project_type_subdivision: "Parcelácia",
    inp_iz: "Index zastavanosti (IZ)",
    inp_kpp: "KPP (koeficient podlažných plôch)",
    inp_floors: "Počet nadzemných podlaží",
    inp_non_res_pct: "Nebytové priestory %",
    inp_min_green_pct: "Min. % zelene",
    inp_avg_apt: "Priemerná výmera bytu",
    inp_mode: "Režim výpočtu",
    inp_mode_conservative: "Konzervatívny (72%)",
    inp_mode_realistic: "Realistický (75%)",
    inp_mode_efficient: "Efektívny (80%)",
    inp_green_on_structure: "Zeleň na konštrukcii",
    inp_parking_ratio: "Kryté parkovanie / byt",
    inp_outdoor_ratio: "Vonkajšie parkovanie / byt",
    inp_paved_pct: "Spevnené plochy % pozemku",
    inp_urban_risk_buffer: "Urban risk buffer %",
    inp_public_roads_pct: "Verejné komunikácie %",
    inp_green_pct: "Min. % zelene na pozemku",
    inp_paved_pct_house: "Spevnené plochy % / parcela",
    inp_min_parcel_size: "Min. výmera parcely",
    inp_max_plot_coverage: "Max. zastavanosť parcely %",
    inp_floors_per_house: "Počet podlaží / dom",
    inp_kpp_house: "KPP / parcela",
    inp_typology: "Typológia domu",
    inp_typology_detached: "Samostatne stojaci",
    inp_typology_semi: "Dvojdom",
    inp_typology_row: "Radový dom",
    inp_risk_buffer_pct: "Efektivita návrhu %",
    inp_parking_per_house: "Parkovanie / dom",
    inp_yes: "Áno",
    inp_no: "Nie",
    inp_not_set: "—",
    m2: "m²",
  ...
  pl: {
    ...
    inputs_title: "Parametry wejściowe",
    inputs_land: "Teren & regulacje",
    inputs_advanced: "Zaawansowane założenia",
    inputs_subdivision: "Parametry parcelacji",
    inp_land_area: "Powierzchnia terenu",
    inp_project_type: "Typ projektu",
    inp_project_type_building: "Zabudowa mieszkaniowa",
    inp_project_type_subdivision: "Parcelacja",
    inp_iz: "Wskaźnik zabudowy (WZ)",
    inp_kpp: "Wskaźnik intensywności (WIZ)",
    inp_floors: "Kondygnacje nadziemne",
    inp_non_res_pct: "Powierzchnia usługowa %",
    inp_min_green_pct: "Min. % zieleni",
    inp_avg_apt: "Średnia pow. mieszkania",
    inp_mode: "Tryb obliczeń",
    inp_mode_conservative: "Konserwatywny (72%)",
    inp_mode_realistic: "Realistyczny (75%)",
    inp_mode_efficient: "Efektywny (80%)",
    inp_green_on_structure: "Zieleń na konstrukcji",
    inp_parking_ratio: "Parkowanie kryte / mieszkanie",
    inp_outdoor_ratio: "Parkowanie zewnętrzne / mieszkanie",
    inp_paved_pct: "Nawierzchnie utwardzone % terenu",
    inp_urban_risk_buffer: "Bufor ryzyka %",
    inp_public_roads_pct: "Drogi publiczne %",
    inp_green_pct: "Min. % zieleni na terenie",
    inp_paved_pct_house: "Nawierzchnie utwardzone % / działka",
    inp_min_parcel_size: "Min. wielkość działki",
    inp_max_plot_coverage: "Max wskaźnik zabudowy %",
    inp_floors_per_house: "Kondygnacje / dom",
    inp_kpp_house: "WIZ / działkę",
    inp_typology: "Typologia domu",
    inp_typology_detached: "Wolnostojący",
    inp_typology_semi: "Bliźniak",
    inp_typology_row: "Szeregowiec",
    inp_risk_buffer_pct: "Bufor efektywności %",
    inp_parking_per_house: "Parkowanie / dom",
    inp_yes: "Tak",
    inp_no: "Nie",
    inp_not_set: "—",
    m2: "m²",
  ...
  hu: {
    ...
    inputs_title: "Bemeneti paraméterek",
    inputs_land: "Telek & szabályozás",
    inputs_advanced: "Speciális feltételezések",
    inputs_subdivision: "Telekfelosztás paraméterei",
    inp_land_area: "Telek területe",
    inp_project_type: "Projekt típusa",
    inp_project_type_building: "Lakóépület fejlesztés",
    inp_project_type_subdivision: "Telekfelosztás",
    inp_iz: "Beépítési arány (BA)",
    inp_kpp: "Intenzitási mutató (IM)",
    inp_floors: "Felszín feletti szintek",
    inp_non_res_pct: "Nem lakáscélú arány %",
    inp_min_green_pct: "Min. zöldfelület %",
    inp_avg_apt: "Átlagos lakásterület",
    inp_mode: "Számítási mód",
    inp_mode_conservative: "Konzervatív (72%)",
    inp_mode_realistic: "Realisztikus (75%)",
    inp_mode_efficient: "Hatékony (80%)",
    inp_green_on_structure: "Zöldfelület a szerkezeten",
    inp_parking_ratio: "Fedett parkolás / lakás",
    inp_outdoor_ratio: "Külső parkolás / lakás",
    inp_paved_pct: "Burkolt felületek % telek",
    inp_urban_risk_buffer: "Kockázati puffer %",
    inp_public_roads_pct: "Közutak %",
    inp_green_pct: "Min. % zöldfelület a telken",
    inp_paved_pct_house: "Burkolt felületek % / telek",
    inp_min_parcel_size: "Min. telekméret",
    inp_max_plot_coverage: "Max. beépítési arány %",
    inp_floors_per_house: "Szintek száma / ház",
    inp_kpp_house: "IM / telkenként",
    inp_typology: "Ház típusa",
    inp_typology_detached: "Szabadon álló",
    inp_typology_semi: "Ikerház",
    inp_typology_row: "Sorház",
    inp_risk_buffer_pct: "Hatékonysági puffer %",
    inp_parking_per_house: "Parkolás / ház",
    inp_yes: "Igen",
    inp_no: "Nem",
    inp_not_set: "—",
    m2: "m²",
  ...
  de: {
    ...
    inputs_title: "Eingabeparameter",
    inputs_land: "Grundstück & Regulierung",
    inputs_advanced: "Erweiterte Annahmen",
    inputs_subdivision: "Parzellierungsparameter",
    inp_land_area: "Grundstücksfläche",
    inp_project_type: "Projekttyp",
    inp_project_type_building: "Wohngebäudeentwicklung",
    inp_project_type_subdivision: "Parzellierung",
    inp_iz: "Grundflächenzahl (GRZ)",
    inp_kpp: "Geschossflächenzahl (GFZ)",
    inp_floors: "Obergeschosse",
    inp_non_res_pct: "Gewerbeflächenanteil %",
    inp_min_green_pct: "Min. Grünflächenanteil %",
    inp_avg_apt: "Durchschn. Wohnungsgröße",
    inp_mode: "Berechnungsmodus",
    inp_mode_conservative: "Konservativ (72%)",
    inp_mode_realistic: "Realistisch (75%)",
    inp_mode_efficient: "Effizient (80%)",
    inp_green_on_structure: "Grünfläche auf Konstruktion",
    inp_parking_ratio: "Überdachte Stellplätze / Whg.",
    inp_outdoor_ratio: "Außenstellplätze / Whg.",
    inp_paved_pct: "Versiegelte Flächen % Grundstück",
    inp_urban_risk_buffer: "Risikopuffer %",
    inp_public_roads_pct: "Öffentliche Wege %",
    inp_green_pct: "Min. % Grünfläche",
    inp_paved_pct_house: "Versiegelte Flächen % / Parzelle",
    inp_min_parcel_size: "Min. Parzellengrö­ße",
    inp_max_plot_coverage: "Max. GRZ %",
    inp_floors_per_house: "Geschosse / Haus",
    inp_kpp_house: "GFZ / Parzelle",
    inp_typology: "Haustyp",
    inp_typology_detached: "Freistehend",
    inp_typology_semi: "Doppelhaus",
    inp_typology_row: "Reihenhaus",
    inp_risk_buffer_pct: "Planungseffizienz-Puffer %",
    inp_parking_per_house: "Stellplätze / Haus",
    inp_yes: "Ja",
    inp_no: "Nein",
    inp_not_set: "—",
    m2: "m²",
...
const WARNING_TEXTS = {
  ...
  pl: {
    cpp_exceeds_hpp: "PUB netto przekracza PUB – sprawdź wskaźnik intensywności lub kondygnacje.",
    ...
    coverage_too_high: "Maks. wskaźnik zabudowy przekracza 50% – sprawdź lokalne przepisy.",
    ...
    apartments_area_clamped: "Powierzchnia mieszkań jest ujemna – zaokrąglona do 0.",
    ...
    land_unallocated: "Wykryto nieprzydzieloną powierzchnię.",
  },
  hu: {
    cpp_exceeds_hpp: "Nettó alapterület meghaladja a bruttót – ellenőrizze az intenzitási mutatót vagy a szintszámot.",
    ...
    coverage_too_high: "A max. beépítési arány meghaladja az 50%-ot.",
    ...
    apartments_area_clamped: "A lakások területe negatív lett – 0-ra kerekítve.",
    ...
    land_balance_exceeded: (v) => `A telekmérleg ${v?.excess_m2 ?? '?'} m²-rel (${v?.excess_pct ?? '?'}%) túllépve. Csökkentse a burkolt felületeket.`,
    land_unallocated: "Nem allokált terület észlelve.",
  },
  de: {
    ...
    apartments_area_clamped: "Wohnfläche wurde negativ – auf 0 gerundet.",
    ...
    land_unallocated: "Nicht zugewiesene Fläche erkannt.",
  },
};
